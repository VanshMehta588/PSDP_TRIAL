...
export default function VidhyarthiMorchaPage() {
    // useGSAP(() => {
                    ...
                    <div className="society_economy_sec">
                        <div className="row align-items-center">
                            <div className="col-sm-12 col-md-6 col-lg-6">
                                <h2 className="title_2">Vidhyarthi Morcha</h2>
                                <p className="lrg_body">
                                    For the last several years, the ruling parties in Gujarat have
                                    been oppressing the people through false promises and unpredictable
                                    rule. Power is being misused to suppress the voice of the people,
                                    unemployment is increasing, atrocities on women are increasing,
                                    and a huge web of corruption is being woven, while the people
