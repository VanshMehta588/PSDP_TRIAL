...
import Sangathan from "@/components/Sangathan";
...
export default async function SangathanPage({ params }: Props) {
    ...
    const { sangathan } = await getData(locale);

    return (
        <>
            <Sangathan sangathan={sangathan} />
            <ReachUsSection />
        </>
    );
}
