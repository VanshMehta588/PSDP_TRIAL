...
export default function GalleryPage() {
  ...
  return (
    <>
      <div className="breadcrumb_section" style={{ background: "url(/assets/img/photo_gallery_bg.jpg)" }}>
            ...
            <div className="photo_gategory_bg">
              ...
              <div className="ui-group">
                <div className="filters button-group js-radio-button-group device-type">
                  {["*", "Events", "Leaders", "Founders", "Infographics", "Cartoons", "Hd_Images", "Inauguration"].map(
                    (category) => (
                      <button
                        key={category}
                  ...
                  <li className={`element-item ${item.category}`} key={item.id} data-category={item.category}>
                    <div className="gallery_card hover_img">
                      ...
                      <ul className="photo_share">
                        ...
                        <li>
                          <a
                            href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(window.location.href)}&text=${encodeURIComponent(item.title)}`}
                            target="_blank"
                            rel="noopener noreferrer"
                          >
